...
df2  = df.iloc[1:3,[1]]
# df2 = df.loc['2020-01-03':'2020-01-06', 'bday']
# print(df2)
...
ones_by_dates = pd.Series(data=1, index=dates)
...
ones_by_cols  = pd.Series(1,index=df.columns)
...
# This will produce a dataframe of NaN (Series的index变成dataframe的列名）
